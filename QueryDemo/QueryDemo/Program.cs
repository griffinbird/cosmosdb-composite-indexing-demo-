    ...
    class Program
    {
        ...
        public static async Task RunDemoMenu(QueryRunner runnerWith, QueryRunner runnerWithout)
        {
            ...
            while (exit == false)
            {
                ...
                Console.WriteLine($"[6]   EXISTS queries");
                Console.WriteLine($"[7]   UDFs vs system functions");
        ...
        private static void PrintComparisonOutput(QueryStats statsWith, QueryStats statsWithout)
        {
            ...
            Console.WriteLine("|With improvemets     |{0, -10}|{1, -16}|", Math.Round(statsWith.RUCharge, 2), statsWith.ExecutionTime);
